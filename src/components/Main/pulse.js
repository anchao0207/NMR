      ...
      <div className="description">
        <div className="decs-text">
            ...
            <div className="center">
              <p>
                <a className="link" onClick={onHClick}><sup>1</sup>{props.link1}</a>
                <a className="link" onClick={onCClick}><sup>13</sup>{props.link2}</a>
                <a className="link" onClick={onFClick}><sup>19</sup>{props.link3}</a>
                <a className="link" onClick={onPClick}><sup>31</sup>{props.link2}</a>
              </p>
            </div>
        </div>
      </div>
